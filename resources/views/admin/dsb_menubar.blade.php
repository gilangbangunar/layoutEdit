        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                <div class="card" align="center">
                    <h5 class="card-header">Kelola Menubar</h5>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table" style="text-align: center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ (strlen($d->deskripsi)>20) ? substr($d->deskripsi,0,20).' ...' : $d->deskripsi}} </td>
                                        <td>
                                            {{ $d->href }}
                                        </td>
                                        <td>
                            ...
                            <a href="{{'/tambahfile/1'}}" class="btn btn-brand btn-block">Tambah Menubar</a>
                        </div>
