        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                <div class="card" align="center">
                    <h5 class="card-header">Kelola Service</h5>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table" style="text-align: center">
                                <thead class="bg-light">
                                    <tr class="border-0">
                                        ...
                                        <th class="border-0">Path Icon</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:20%">{{ (strlen($d->deskripsi)>20) ? substr($d->title,0,20).' ...' : $d->title}} </td>
                            ...
                            <a href="{{'/tambahfile/1'}}" class="btn btn-brand btn-block">Tambah Service</a>
                        </div>
