        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                <div class="card" align="center">
                    <h5 class="card-header">Kelola Galleri</h5>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table" style="text-align: center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:20%">{{ (strlen($d->desc)>20) ? substr($d->desc,0,20).' ...' : $d->deskripsi}} </td>
                            ...
                            <a href="{{'/tambahfile/1'}}" class="btn btn-brand btn-block">Tambah Galleri</a>
                        </div>
